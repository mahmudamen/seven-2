...
public class HouseActivity extends AppCompatActivity {
    ...
    private static String TAG = "HouseActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (RelativeLayout) findViewById(R.id.activity_house);
        ...
        Query myRef = database.getReference("House").limitToFirst(10).orderByChild("id");
    ...
    public void loaddate(NetworkInfo currentNetworkInfo){
        ...
        if(currentNetworkInfo == null ){
            ...
            HouseAdapter houseAdapter = new HouseAdapter(list, HouseActivity.this);
            RecyclerView.LayoutManager recyce = new GridLayoutManager(HouseActivity.this, 1);
