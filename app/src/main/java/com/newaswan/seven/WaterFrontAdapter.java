...
public class WaterFrontAdapter extends RecyclerView.Adapter<WaterFrontAdapter.MyHoder>{
    ...
    public WaterFrontAdapter(List<PhotoModel> list, Context context) {
        this.list = list;
    ...
    public MyHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardwaterfront, parent, false);
