...
public class SalesActivity extends AppCompatActivity {
    ...
    private static String TAG = "SalesActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query myRef = database.getReference("SalesActivity").orderByChild("id");
    ...
    public void loaddate(NetworkInfo currentNetworkInfo){
        ...
        if(currentNetworkInfo == null ){
          ...
          //  SalesAdapter salesAdapter = new SalesAdapter(list, SalesActivity.this);
            RecyclerView.LayoutManager recyce = new GridLayoutManager(SalesActivity.this, 1);
            recycle.setLayoutManager(recyce);
            recycle.setItemAnimator(new DefaultItemAnimator());
         //   recycle.setAdapter(salesAdapter);
