...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.MyHoder>{
    ...
    public MyHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardphoto, parent, false);
