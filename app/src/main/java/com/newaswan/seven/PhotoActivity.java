...
public class PhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query myRef = database.getReference("PhotoActivity").orderByChild("id");
    ...
    public void loaddate(NetworkInfo currentNetworkInfo){
        ...
        if(currentNetworkInfo == null ){
            ...
            PhotoAdapter photoAdapter = new PhotoAdapter(list, PhotoActivity.this);
            RecyclerView.LayoutManager recyce = new GridLayoutManager(PhotoActivity.this, 1);
            recycle.setLayoutManager(recyce);
            recycle.setItemAnimator(new DefaultItemAnimator());
            recycle.setAdapter(photoAdapter);
            //progressDialog.dismiss();
        }
    }
}