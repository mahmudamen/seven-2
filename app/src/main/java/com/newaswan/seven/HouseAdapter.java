...
public class HouseAdapter extends RecyclerView.Adapter<HouseAdapter.MyHoder>{
  ...
  // final Typeface face = Typeface.createFromAsset(context.getAssets(),"fonts/alyoum.ttf");
    public HouseAdapter(List<PhotoModel> list, Context context) {
        this.list = list;
...
TextView textViewPrice ,textViewRating,textViewShortDesc,textViewTitle;
        //   View view = LayoutInflater.from(context).inflate(R.layout.cardsales,parent,false);
        //   MyHoder myHoder = new MyHoder(view);

        RecyclerView.ViewHolder vh;
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardhouse, parent, false);
