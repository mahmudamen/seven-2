    ...
    public void loaddate(NetworkInfo currentNetworkInfo){
        ...
        if(currentNetworkInfo == null ){
           progressDialog.dismiss();
            ...
            ProjectAdapter projectAdapter = new ProjectAdapter(list, ProjectActivity.this);
            RecyclerView.LayoutManager recyce = new GridLayoutManager(ProjectActivity.this, 1);
            recycle.setLayoutManager(recyce);
            recycle.setItemAnimator(new DefaultItemAnimator());
            recycle.setAdapter(projectAdapter);
            //progressDialog.dismiss();
        }
    }
}